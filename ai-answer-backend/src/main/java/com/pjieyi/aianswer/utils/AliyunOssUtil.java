package com.pjieyi.aianswer.utils;
...
import com.pjieyi.aianswer.constant.FileConstant;
...
public class AliyunOssUtil {
    ...
    //OSS中存储的位置
    private  String objectName = "yudada/";
    ...
    public  String upload(String fileName,InputStream inputStream){
        ...
        try {
            ...
            url= FileConstant.OSS_HOST+"/"+objectName+fileName;
